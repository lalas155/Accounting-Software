...
def read_env_file():
    load_dotenv(os.path.dirname(os.path.realpath(__file__))+"\server_data.env")
...
if option=="1":
    ...
    while use_env_file not in ["Yes","No"]:
        use_env_file=input("Would you like to import Server data from server_data.env file? Type 'Yes' if you would like to, otherwise type 'No'.\n Answer: ")
    if use_env_file=="Yes":
